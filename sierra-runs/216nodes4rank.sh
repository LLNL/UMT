...
##BSUB -csm y
##BSUB -R "1*{select[LN]} + ${cores_per_socket}*${num_sockets}*{select[CN&&(hname!=sierra1448)&&(hname!=sierra2065)&&(hname!=sierra689)&&(hname!=sierra3248)&&(hname!=sierra2754)&&(type==any)]span[ptile=40]}"
