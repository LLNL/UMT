...
!  passed variables
   ...
   ZoneLoop: do zone=1,nzones
     ...
     CornerLoop: do c=c0+1,c0+nCorner
       ...
       ! The SUM is over groups
       radEnergy_phiTotal = radEnergy_phiTotal + Vol*SUM(Geom% PhiTotal(:,c))
       matEnergy_tec = matEnergy_tec + Rho*Cve*Mat%Tec(c)*Vol
   ...
   if (Options%isRankVerbose() >= minimumVerbosityLevel) then
     ...
     print '(a,i6,a,E24.14E3)', " Rank ", Size%myRankInGroup, " Radiation Energy computed from psi: ", radEnergy_psi
     print '(a,i6,a,E24.14E3)', " Rank ", Size%myRankInGroup, " Radiation Energy computed from Geom%phiTotal: ", radEnergy_phiTotal
     print '(a,i6,a,E24.14E3)', " Rank ", Size%myRankInGroup, " Material Energy computed from Tec: ", matEnergy_tec
     print '(a,i6,a,E24.14E3)', " Rank ", Size%myRankInGroup, " Source Energy computed from GSet%STotal: ", sourceEnergy
     print *, "============================================================"
   endif

   call MPIAllReduce(radEnergy_psi, "sum", MY_COMM_GROUP)
   call MPIAllReduce(radEnergy_phiTotal, "sum", MY_COMM_GROUP)
   call MPIAllReduce(matEnergy_tec, "sum", MY_COMM_GROUP)
   ...
   if (Size%myRankInGroup == 0) then
     ...
     print *, "============================================================"
     print '(a,a,a,i6)', " in file/location: ", routine
     print '(a,E24.14E3)', " GLOBAL Radiation Energy computed from psi: ", radEnergy_psi
     print '(a,E24.14E3)', " GLOBAL Radiation Energy computed from Geom%phiTotal: ", radEnergy_phiTotal
     print '(a,E24.14E3)', " GLOBAL Material Energy computed from Tec: ", matEnergy_tec
     print '(a,E24.14E3)', " GLOBAL Source Energy computed from GSet%STotal: ", sourceEnergy
     print *, "============================================================"
   endif
