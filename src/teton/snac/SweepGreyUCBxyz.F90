...
!***********************************************************************
   ...
   subroutine SweepGreyUCBxyzNEW(setID, Angle, PsiB)
...
!$omp& schedule(static)
     ZoneLoop: do ii=1,nzones
       ...
       call SweepGreyUCBxyzKernel(setID, nCorner, c0, angle0, &
                                  Angle, omega, PsiB)
...
!$omp end parallel do
   ...
   return
   end subroutine SweepGreyUCBxyzNEW



   subroutine SweepGreyUCBxyzKernel(setID, nCorner, c0, angle0, &
                                    Angle, omega, PsiB) 
